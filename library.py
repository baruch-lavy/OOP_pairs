...
from OOP_pairs.user import Member
from OOP_pairs.loan import Loan
...
class Library:
    ...
    def add_book(self,title,book):
        ...
        FileManegment.json_write('OOP_pairs/books.json',book)
    
    is_new_user = True
    def add_member(self,name,member):
        self.members[name] = member
        FileManegment.json_write('OOP_pairs/users.json',member)
       
    def borrow(self,book:Book,member:Member,loan:Loan):
...
# create books
book_1 = Book('harry potter','j.k rolling',True)
book_2 = Book('the hobbit','tolkin',True)
book_3 = Book('lord of the rings','tolkin',True)

# create members
# member_1 = Member('baruch lavy',0)
# member_2 = Member('michal lavy',0)
...
# create loans
# loan_1 = Loan(book_1.id,member_1.id)
# loan_2 = Loan(book_2.id,member_1.id)
# print(loan_1.__dict__)

# execute_loans
# library.borrow(book_1,member_1,loan_1)
# library.borrow(book_2,member_1,loan_2)
# print(library.loans)
